...
Unity 2021.3+ (compatible también con versiones superiores).
Plugin I2 Localization instalado en el proyecto.
Permisos de acceso a la hoja de cálculo si usas Google Sheets como fuente de CSV.
